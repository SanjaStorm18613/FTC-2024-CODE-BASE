...
public abstract class CameraGLRendererBase implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        synchronized(this) {
            ...
            CameraGLSurfaceView.CameraTextureListener texListener = mView.getCameraTextureListener();
            if(texListener != null) {
    ...
    protected void doStop() {
        ...
        CameraGLSurfaceView.CameraTextureListener listener = mView.getCameraTextureListener();
